                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({href, icon}, key) => (
                            <a key={key} href={href} target="_blank" className="w-12 h-12 grid place-items-center ring-inset right-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
                                {icon}
                            </a>
                        ))}
                    </div>
                </div>
                <form action="https://getform.id/f/" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="md-4">
                            <label htmlFor="name" className="label reveal-up">
                                Name
                            </label>
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Nguyen Tien Dung" className="text-field reveal-up"/>
                        </div>
                        <div className="md-4">
                            <label htmlFor="email" className="label reveal-up">
                                Email
                            </label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="ntd3121410111@gamil.com" className="text-field reveal-up"/>
                        </div>
                    </div>
                    <div className="mb-4">
                    ...
                    <button type="submit" className="btn btn-primary !max-w-none w-full justify-center reveal-up">
                        Submit
                    </button>
                </form>
            </div>
